(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Supports_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Supports/Add.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Supports/Add.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add() {
    ...
    _defineProperty(_assertThisInitialized(_this), "submitHandler", function (e) {
      e.preventDefault();
      if (_this.props.edit) _this.props.patch(_this.props.match.params.supportId, e.target);else _this.props.post(e.target);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "inputChangeHandler", function (e) {
      ...
      if (name.includes('currencies')) {
        var currencies = _toConsumableArray(_this.state.currencies);

        if (name.includes('id')) {
          var _id$split = id.split('-'),
              _id$split2 = _slicedToArray(_id$split, 2),
              currency_id = _id$split2[1];

          var currency = currencies.find(function (c) {
            return +c.id === +currency_id;
          });
          if (checked && !currency) currencies.push({
            id: currency_id,
            balance: ''
          });else currencies = currencies.filter(function (c) {
            return +c.id !== +currency_id;
          });
        } else if (name.includes('balance')) {
          var _id$split3 = id.split('-'),
              _id$split4 = _slicedToArray(_id$split3, 2),
              _currency_id = _id$split4[1];

          var currencyIndex = currencies.findIndex(function (c) {
            return +c.id === +_currency_id;
          });
          console.log({
            value: value,
  ...
  _createClass(Add, [{
    ...
    value: function componentDidMount() {
      this.props.reset();
      if (this.props.edit) this.props.get(this.props.match.params.supportId);else this.props.info();
    }
  }, {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.supports,
      ...
      var currenciesItems = currencies.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (currency) {
        var element = c.find(function (i) {
          return +i.id === +currency.id;
        });
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
            type: "switch",
            id: "currency-".concat(currency.id),
            className: "col-12 pb-2",
            checked: checked,
            name: "currencies[".concat(currency.id, "][id]"),
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_18__.default, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_19__.default, {
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_9__.default, {
                  type: "number",
                  id: "currency-".concat(currency.id, "-balance"),
                  name: "currencies[".concat(currency.id, "][balance]"),
                  icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_20__.faWallet,
                  onChange: _this2.inputChangeHandler,
                  value: element.balance,
                  placeholder: form.balance
                })
              })
            })
          })]
        ...
        content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_8__.default, {
              ...
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_20__.faBorderNone,
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_18__.default, {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_12__.default, {
                  ...
                  children: [this.props.edit && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", {
                    ...
                    children: form.currencies
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_19__.default, {
                    className: "col-12",
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.supports.support && prevState.name === '') {
        var support = nextProps.backend.supports.support;
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_14__.updateObject)(prevState, _objectSpread({}, support));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__.getSupport(id));
    },
    info: function info() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__.getSupportsInfo());
    },
    post: function post(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__.postSupports(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__.patchSupports(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__.resetSupports());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Supports/Edit.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Supports/Edit.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/User/Supports/Add.js");
