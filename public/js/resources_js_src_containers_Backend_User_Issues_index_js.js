(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Issues_index_js"],{
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = issues.map(function (issue) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(issue, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.getIssues(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.deleteIssues(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.resetIssues());
    }
  };
};
