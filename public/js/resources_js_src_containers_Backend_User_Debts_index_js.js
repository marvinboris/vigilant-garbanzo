(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Debts_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Debts/index.js":
/*!*****************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Debts/index.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          debts = _this$props$backend$d.debts,
          total = _this$props$backend$d.total,
      ...
      if (!debts) debts = [];
      var data = debts.map(function (claim) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(claim, {
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_14__.Link, {
              ...
              to: "/user/debts/".concat(claim.id, "/edit"),
              className: "mx-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_3__.FontAwesomeIcon, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.getDebts(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.deleteDebts(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.resetDebts());
    }
  };
};
