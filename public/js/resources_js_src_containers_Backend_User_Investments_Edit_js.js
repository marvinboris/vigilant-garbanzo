(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Investments_Edit_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Investments/Add.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Investments/Add.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add() {
    ...
    _defineProperty(_assertThisInitialized(_this), "submitHandler", function (e) {
      e.preventDefault();
      if (_this.props.edit) _this.props.patch(_this.props.match.params.investmentId, e.target);else _this.props.post(e.target);
    });
  ...
  _createClass(Add, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.props.reset();
                if (this.props.edit) this.props.get(this.props.match.params.investmentId);else this.props.info();
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.investments,
      ...
      var _this$state = this.state,
          ...
          support_id = _this$state.support_id,
          currency_id = _this$state.currency_id;
      var content = null;
      var errors = null;
      var feature = features.find(function (f) {
        return f.prefix === 'investments';
      });
      ...
      var supportsOptions = supports.sort(function (a, b) {
      ...
      var support = supports.find(function (support) {
        return +support.id === +support_id;
      });
      var currencies = support ? support.currencies : [];
      var currenciesOptions = currencies.sort(function (a, b) {
        return a.name > b.name;
      }).map(function (item) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("option", {
          value: item.id,
        ...
        content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(reactstrap__WEBPACK_IMPORTED_MODULE_17__.default, {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_10__.default, {
              ...
              icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faSearchDollar,
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(reactstrap__WEBPACK_IMPORTED_MODULE_16__.default, {
                ...
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_13__.default, {
                  ...
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    ...
                    name: "delay",
                    required: true,
                    placeholder: form.delay
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_11__.default, {
                    type: "number",
                    className: "col-md-6",
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faWallet,
                    onChange: this.inputChangeHandler,
                    value: amount,
                    name: "amount",
                    required: true,
                    ...
                    type: "number",
                    className: "col-md-6",
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faPercent,
                    onChange: this.inputChangeHandler,
                    value: rate,
                    name: "rate",
                    required: true,
                    ...
                    type: "select",
                    name: "support_id",
                    placeholder: form.support,
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faBorderNone,
                    validation: {
                      required: true
                    },
                    required: true,
                    ...
                    onChange: this.inputChangeHandler,
                    icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_18__.faDollarSign,
                    validation: {
                      required: true
                    },
                    required: true,
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.investments.investment && prevState.date === '') {
        var investment = nextProps.backend.investments.investment;
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_15__.updateObject)(prevState, _objectSpread({}, investment));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getInvestment(id));
    },
    info: function info() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.getInvestmentsInfo());
    },
    post: function post(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.postInvestments(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.patchInvestments(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__.resetInvestments());
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Investments/Edit.js":
/*!**********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Investments/Edit.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Add__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Add */ "./resources/js/src/containers/Backend/User/Investments/Add.js");
